...
public class SList {
  ...
  public static void main (String[] args) {
	...
	lstTest.insertFront(new Integer(12));
	lstTest.insertFront(new Integer(9));
	lstTest.insertFront(new Integer(6));
	System.out.println();
	...
	System.out.println();
    System.out.println("Here is a list after insertFront 3 and insertEnd 15: "
		       + lstTest.toString());
